...
Suggested dependencies should be installed automatically by `devtools`. If after running the previous commands you find that `fafreqs` is still not working you can try installing the dependencies yourself by running
